...
public class DashboardPageTest extends BaseTest {
    ...
    public void userCanAddDashboard() {
        ...
        allDashboardsPage = dashboardPage.clickAllDashboardLink();
    ...
    public void userCanEditDashboard() {
        ...
        addEditDashboardModelPage = allDashboardsPage.clickEditDashboard(dashboard);

        /* @Step 6: Edit created dashboard; Expected: Dashboard edited, info message appears */
        dashboard.setName(MockDataUtils.generateName());
        allDashboardsPage = addEditDashboardModelPage.editDashboard(dashboard);
